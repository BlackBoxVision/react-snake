                ...
                <Flex backgroundColor="transparent" height="100vh" width="100vw">
                    <Card>
                        <Container backgroundColor="#388E3C" height="100vh" width="45.5vw">
                            <img src={require('../../images/logo/logo.png')} alt="game logo" width="85%" style={{ paddingTop: 75, paddingLeft: 50, paddingRight: 50 }}/>
                            <CardText>
                                <Container margin="50px" padding="10px 0px 0px 0px">
